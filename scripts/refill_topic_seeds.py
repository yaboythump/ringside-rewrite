...
_FALLBACK_PREMISES = (
    ...
    "What if British Bulldog’s SummerSlam 1992 victory launched him into the WWF Championship picture?",
    ...
    "What if Christian kept the World Heavyweight Championship after Extreme Rules 2011?",
    ...
    "What if Kharma returned to WWE full-time in 2012?",
    ...
    "What if Bayley defeated Asuka at NXT TakeOver: Dallas and kept the NXT Women’s Championship?",
    "What if Ronda Rousey stayed undefeated through WrestleMania 35?",
    "What if Ric Flair never left WCW in 1991?",
    "What if Sting defeated Hulk Hogan decisively without the controversial restart at Starrcade 1997?",
    ...
    "What if Kevin Nash refused to hand the WCW Championship back to Hulk Hogan in the Fingerpoke of Doom?",
    ...
    "What if Wardlow’s TNT Championship reign after Revolution 2023 lasted through the summer?",
    ...
    "What if Kofi Kingston never lost the WWE Championship to Brock Lesnar in 2019?",
