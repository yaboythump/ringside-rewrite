...
for i,dur in enumerate(durs,1):
    ...
    denom=str(max(1,frames-1))
    if variant==0: zp="zoompan=z='min(zoom+0.00065,1.08)':x='iw/2-(iw/zoom/2)':y='ih/2-(ih/zoom/2)'"
    elif variant==1: zp="zoompan=z='min(zoom+0.00055,1.07)':x='(iw-iw/zoom)*on/"+denom+":y='ih/2-(ih/zoom/2)'"
    elif variant==2: zp="zoompan=z='min(zoom+0.00055,1.07)':x='iw-iw/zoom-(iw-iw/zoom)*on/"+denom+":y='ih/2-(ih/zoom/2)'"
    elif variant==3: zp="zoompan=z='1.055':x='iw/2-(iw/zoom/2)':y='(ih-ih/zoom)*on/"+denom+"'"
    else: zp="zoompan=z='1.055':x='iw/2-(iw/zoom/2)':y='ih-ih/zoom-(ih-ih/zoom)*on/"+denom+"'"
